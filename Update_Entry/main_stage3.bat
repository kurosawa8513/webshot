...
cd %BASEPATH%
python list2ticket.py urllist\URLLIST_2ch.org.txt      	%OUTBOX__%     TODAY	10	5
python list2ticket.py urllist\URLLIST_company.org.txt	%OUTBOX__%     WEEK		10	20
python list2ticket.py urllist\URLLIST_DQW.ORG.txt		%OUTBOX__%     NOW		10	5
python list2ticket.py urllist\URLLIST_IT.org.txt		%OUTBOX__%     WEEK		10	30
...
python list2ticket.py urllist\URLLIST_shop.org.txt		%OUTBOX__%     TODAY	10	10
